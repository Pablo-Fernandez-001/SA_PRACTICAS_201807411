...
docker stop delivereats-auth-service delivereats-api-gateway delivereats-frontend delivereats-auth-db 2>nul
...
docker volume rm delivereats_auth_db_data 2>nul
docker volume rm practica2_auth_db_data 2>nul
