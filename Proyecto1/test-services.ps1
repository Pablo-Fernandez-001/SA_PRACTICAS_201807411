...
try {
    $response = Invoke-WebRequest -Uri "http://localhost:8080/api/catalog/restaurants" -UseBasicParsing
...
try {
    $response = Invoke-WebRequest -Uri "http://localhost:3003/health" -UseBasicParsing
...
try {
    $response = Invoke-WebRequest -Uri "http://localhost:3004/health" -UseBasicParsing  
